...
//Used above for the docker provider to get ecr authentication
...
//ECS cluster, service and corresponding task definiton
...
locals {
  ...
  database_password = "foobarbaz" // WARNING: This is a placeholder. Consider using a more secure method for managing secrets.
}
